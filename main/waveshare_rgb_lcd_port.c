...
/**
 * @brief I2C master initialization (legacy)
 */
...
esp_err_t waveshare_esp32_s3_rgb_lcd_init()
{
    ...
    esp_lcd_rgb_panel_config_t panel_config = {
        ...
        .timings = {
            ...
            .h_res = EXAMPLE_LCD_V_RES,            // Native horizontal resolution
            .v_res = EXAMPLE_LCD_H_RES,            // Native vertical resolution
    ...
    ESP_ERROR_CHECK(esp_lcd_panel_swap_xy(panel_handle, true)); // Rotate screen 90 degrees
    // No rotation: keep native landscape
    ...
    ESP_ERROR_CHECK(i2c_master_init());     // Initialize the I2C master and ensure driver is installed
    ...
    const esp_lcd_touch_config_t tp_cfg = {
        .x_max = EXAMPLE_LCD_H_RES,                // Native X coordinate
        .y_max = EXAMPLE_LCD_V_RES,                // Native Y coordinate
...
void example_lvgl_demo_ui(lv_disp_t *disp) // LVGL demo UI initialization function
{
    lv_obj_t *scr = lv_disp_get_scr_act(disp);                                  // Get the current active screen for the provided display
